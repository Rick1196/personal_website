...
const AboutMeSection: React.FC = () => {
  return (
    <>
      <div className="min-h-full h-full w-full p-2">a</div>
      <div className="min-h-full h-full w-full p-2">b</div>
    </>
  );
};
  ...
  return (
    <>
      <div className="flex justify-end items-center gap-2">
        ...
        <p>Current years of experience</p>
      </div>
...
export default function Home() {
  return (
    <>
      ...
      <section className="min-h-[600px] border"></section>
    </>
  );
}
